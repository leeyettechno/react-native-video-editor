    ...
    if (!this.state.isRecording) {
      this.camera
        ...
        .then(data => {
          console.log(data);
          this.setState({
            videoUrls: [...this.state.videoUrls, data.path],
            cameraModal: false,
          });
        })
      ...
      <View style={styles.container}>
        ...
        <Modal
          ...
          <Camera
            ...
            <Text style={styles.capture} onPress={this.takeVideo.bind(this)}>
              [CAPTURE]
            </Text>
          </Camera>
        </Modal>
        ...
        <Modal
          ...
          <Video
            source={{uri: this.state.mergedVideo}} // Can be a URL or a local file.
